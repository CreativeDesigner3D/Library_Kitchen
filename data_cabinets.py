...
class Open_Cabinet(bp_types.Assembly):
...
class Drawer_Cabinet(bp_types.Assembly):
    show_in_library = True
    category_name = "Cabinets"
    prompt_id = "kitchen.cabinet_prompts"
    placement_id = "kitchen.place_cabinet"
    ...
    def draw(self):
        ...
        drawers = self.add_assembly(data_cabinet_doors.Drawers())
        drawers.set_name('Drawers')
        drawers.loc_x('material_thickness',[material_thickness])
        drawers.loc_y('depth',[depth])
        drawers.loc_z('toe_kick_height+material_thickness',[toe_kick_height,material_thickness])
        drawers.dim_x('width-(material_thickness*2)',[width,material_thickness])
        drawers.dim_y('depth',[depth])
        drawers.dim_z('height-toe_kick_height-(material_thickness*2)',[height,toe_kick_height,material_thickness])
